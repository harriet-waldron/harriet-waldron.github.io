  ...
  return (
    <>
      ...
      <section class="post-article"> <p><h4>What kind of person am I?</h4>
        ...
        authenticity makes for happier beings and more nourishing friend groups / workplaces / anywhere humans exist. <br></br>
        ...
        important, but there are so many excellent people out there, so I will not hold on to people who don't treat me well. <br></br>
        ...
        These are radical inclusion, <br></br>
        gifting, <br></br>
        decommodification, <br></br>
        radical self-reliance, <br></br>
        radical self-expression, <br></br>
        communal effort, <br></br>
        civic responsibility, <br></br> 
        leaving no trace, <br></br>
        participation, <br></br>
        immediacy,<br></br>
        and consent. <br></br>
        ...
        and extends to so many small areas of life. <br></br>
        ...
        making coffee and wondering what my new life purpose would be. <br></br>
        ...
        hour shift at the cafe and be so excited to go home and study. <br></br>
        ...
        computer at the best of times, and was typing at about 6 words per minute when I began. <br></br>
        ...
        I was able to respect him, and the less patience I had for him. It was affecting my enjoyment of my work, and so I decided to talk to him. <br></br>
        I was 
        ...
        This is not the first time I have used that strategy with a manager, and it generally works. <br></br> I have found if you approach people with kindness 
        ...
        gardening, building and creating. It was an exciting place to live, and the communal effort required of you was high. <br></br> To run this kind of place 
        ...
        to keep the space running, and too many people believed in the system. People who wanted to change things were reminded they didn't have to live there if they didn't like the rules.  
         <br></br> It was an interesting experience to get to see some of my ethics tested in a way where they were overly 
